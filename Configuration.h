...
#define STRING_CONFIG_H_AUTHOR "Wotan X1 Firmware by JetDev22" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Wotan X1"
...
/**
 * Default Axis 032886 Per Unit (steps/mm)
 * Override with M92
